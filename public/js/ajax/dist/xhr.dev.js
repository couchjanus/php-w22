...
function myConsole(c) {
  var status = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  var message, alertClass, text;
  ...
  text = "<div class=\"alert ".concat(alertClass, "\" role=\"alert\">").concat(message, "</div>");
...
function sendRequest() {
  ...
  var url = 'https://reqres.in/api/products/1'; // Проверяем существование запроса
